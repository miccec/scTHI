...
#' 
#' @description  Indentification of  significantly activated ligand-receptor 
...
#' 
#' @details Please have a look at the vignette for a in-depth introduction to the package.
#' @docType package
#' @name scTHI
NULL